# MindNest app — Codex Project Context
...
| AI — Nest chat | Anthropic SDK (Codex) | ^0.36.0 |
...
### Codex Model
**Codex-haiku-4-5-20251001** — used for all Nest AI responses (chat, mood,
community replies, activity generation, wellness check-ins).
Always use this model ID when modifying or adding Codex API calls.
...
├── lib/
│   ├── Codex/index.ts       — Anthropic client singleton
...
- **Nest AI Chat** — Conversational parenting companion using Codex Haiku,
...
All skills available in Codex via /command syntax
...
- Always run Codex from ~/Desktop/BRAINS.ai/mindnest-app
